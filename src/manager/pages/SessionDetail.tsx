    ...
    <div className="p-6 max-w-4xl">
      ...
      <div className="text-sm text-slate-500 mb-4">
        ...
        {topic && (
          <>
            ...
            <Link to={`/topic/${topic.id}`} className="text-brand-600 hover:text-brand-700 hover:underline">
              {topic.title}
            </Link>
          </>
        )}
        <span className="mx-1.5 text-slate-300">/</span>
        <span className="text-slate-900 font-medium">{session.title}</span>
      </div>
          ...
          <div className="flex-1 min-w-0">
            {editingTitle ? (
              <div className="flex items-center gap-2 mb-2">
                ...
                />
                <button onClick={handleTitleSave} className="btn-primary">
                  Save
                </button>
                <button
                  onClick={() => {
              ...
              <h1
                className="text-xl font-bold text-slate-900 mb-2 cursor-pointer hover:text-brand-600 transition-colors"
      ...
      <div className="card-static p-6 mb-6">
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-semibold text-slate-700">Session Summary</h2>
          {editingSummary ? (
      ...
      <div className="card-static p-6 mb-6">
        <h2 className="text-sm font-semibold text-slate-700 mb-3">Parent Session</h2>
